...
const faqs = [
    {
        ...
        content: 'We accept partners generating a minimum of 500kg of waste per month. Whether you\'re a small business or a large industrial facility, our fleet scales to match your output.'
    },
    {
        title: 'Business type & industry',
        content: 'We work with manufacturing plants, construction firms, hospitality businesses, healthcare facilities, and more. If your operations generate waste, we have a solution tailored for you.'
    },
    {
        title: 'Location & service area',
        content: 'Our network currently covers major urban and industrial zones. We\'re continuously expanding — reach out to check if your area is within our active service routes.'
    },
    {
        title: 'Compliance & permits',
        content: 'Partners are required to hold valid waste disposal documentation as per local environmental regulations. Our team can guide you through the compliance process if needed.'
    }
]
</script>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-5">
                        <div v-for="(item, index) in faqs" :key="index" class="flex flex-col">
                            <!-- Header -->
                            <div class="flex items-center justify-between w-full p-7.5 bg-primary-color cursor-pointer select-none transition-all duration-300"
                                :class="openIndex === index ? 'rounded-t-xl' : 'rounded-xl'" @click="toggle(index)">
                                <p class="text-body font-medium">{{ item.title }}</p>
                                <img :src="openIndex === index ? iconMinus : iconPlus" alt=""
                                    class="transition-all duration-300" />
                            </div>

                            <!-- Content -->
                            <div class="overflow-hidden transition-all duration-300 ease-in-out" :style="openIndex === index
                                ? `max-height: ${contentHeights[index] ?? 200}px; opacity: 1`
                                : 'max-height: 0px; opacity: 0'">
                                <div :ref="el => setRef(el, index)" class="p-7.5 pt-0 rounded-b-xl bg-primary-color">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 w-fit h-fit gap-y-6">
                        <li class="flex items-center gap-2">
                            ...
                            <span class="text-body font-medium text-text-third-color">Waste disposal license</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <img src="../../assets/icons/home/checkmark-green.svg" alt="">
                            <span class="text-body font-medium text-text-third-color">Proof of business
                                registration</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <img src="../../assets/icons/home/checkmark-green.svg" alt="">
                        ...
                        <li class="flex items-center gap-2">
                            <img src="../../assets/icons/home/checkmark-green.svg" alt="">
                            <span class="text-body font-medium text-text-third-color">Environmental compliance
                                cert</span>
                        </li>
                    </ul>
                </div>
