    ...
    <div class="container mx-auto py-10">
      <div class="flex flex-col">
        ...
        >
          ...
          Our Impact</span
        >
        <h2 class="medium-heading font-medium text-primary-color mt-10">
          Numbers that speak <br />
          for the <span class="text-accent-color">planet</span>.
        </h2>
        <p class="text-body text-primary-color/55 mt-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0.5 mt-10">
        <div class="flex flex-col gap-2 bg-fourth-color px-8 py-12 rounded-l-lg">
          <h3 class="text-display font-bold text-accent-color">98%</h3>
          <p class="text-body font-semibold text-primary-color/55">Customer Satisfaction</p>
          <p class="text-small text-primary-color/55">
            Volunteers who return again and again to take action with us.
          </p>
        </div>
        <div class="flex flex-col gap-2 bg-fourth-color px-8 py-12">
          <h3 class="text-display font-bold text-accent-color">98%</h3>
          <p class="text-body font-semibold text-primary-color/55">Customer Satisfaction</p>
          <p class="text-small text-primary-color/55">
            Volunteers who return again and again to take action with us.
        ...
        <div class="flex flex-col gap-2 bg-fourth-color px-8 py-12 rounded-r-lg">
          <h3 class="text-display font-bold text-accent-color">98%</h3>
          <p class="text-body font-semibold text-primary-color/55">Customer Satisfaction</p>
          <p class="text-small text-primary-color/55">
            Volunteers who return again and again to take action with us.
